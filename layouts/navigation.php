    <header class="main_menu_area">
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="#"><img src="img/bluenix-logo.png" alt width="360px" height="90px"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav">
            ...
            <li class="nav-item blog"><a class="nav-link" href="blog.php?page=blog">Blog</a></li>
            <li class="nav-item contact"><a class="nav-link" href="contact.php?page=contact">Contact</a></li>
          </ul>
        </div>
      </nav>
    </header>